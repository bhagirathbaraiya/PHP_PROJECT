...
header('location:index.php');
    ...
    $query = mysqli_query($con, "SELECT * FROM students WHERE grno='$student_id'");
    ...
    <div class="profile-glass-bg">
        <div class="profile-glass-card">
            ...
            <div class="profile-glass-image-wrap">
                <img src="https://student.marwadiuniversity.ac.in:553/handler/getImage.ashx?SID=<?php echo strtoupper(($student_data['grno'])); ?>" alt="Student Photo" class="profile-glass-image">
            </div>
                <div class="profile-glass-name"><?php echo htmlspecialchars($student_data['fname'] . ' ' . $student_data['lname']); ?></div>
                <div class="profile-glass-id">Student ID: <?php echo htmlspecialchars($student_data['grno']); ?> , <?php echo htmlspecialchars($student_data['erno']); ?></div>
